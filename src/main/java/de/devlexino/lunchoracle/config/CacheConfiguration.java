package de.devlexino.lunchoracle.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("LunchOracle");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("LunchOracle");
        ...
        config.getMapConfigs().put("de.devlexino.lunchoracle.domain.*", initializeDomainMapConfig(jHipsterProperties));
